...
class TeacherTimetableApp(tk.Tk):
    def __init__(self):
        ...
        # Load initial data
        self.load_teachers()
        # Start the highlight loop that will periodically check and highlight teacher's current class cell
        try:
    ...
    def create_main_layout(self):
        ...
        details_frame = ttk.LabelFrame(right_frame, text="Selected Teacher", padding=10, style="Details.TLabelframe")
        details_frame.pack(fill=tk.X, pady=(0, 10))
